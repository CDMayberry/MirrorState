...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal void OnStartNetworkInternal()
        {
            if (!_networkStarted)
            {
                OnStartNetwork();
        ...
        internal void OnStopNetworkInternal()
        {
            if (_networkStarted)
            {
                OnStopNetwork();
        ...
        /// <summary>
        /// This is invoked for NetworkBehaviour objects when they become active.
        ...
        /// <summary>
        /// Invoked when the object is unspawned
